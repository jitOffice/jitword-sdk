...
}, ce = (e) => e ? e.tagName === "ME-TPC" : false, re = (e) => e.filter((t) => {
...
var At = Object.defineProperty, jt = (e, t, n) => t in e ? At(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n, E = (e, t, n) => (jt(e, typeof t != "symbol" ? t + "" : t, n), n);
class Dt {
  constructor() {
...
const un = function(e, t) {
  ...
  if (s.tagName === "ME-PARENT") {
    ...
    s.tagName === "ME-ROOT" && (un(e.direction, o.nodeObj) === T ? (i = document.querySelector(".lhs")) == null || i.appendChild(n) : (r = document.querySelector(".rhs")) == null || r.appendChild(n), e.linkDiv());
}, ge = function(e, t, n) {
  if (!t)
    return null;
  const o = t.nodeObj;
...
const ee = 100, no = '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">', oo = (e, t = false) => {
  var u, d, m;
...
const ro = function(e = false, t) {
  const n = oo(this, e), o = so(n, t);
  return new Blob([o], { type: "image/svg+xml" });
}, lo = async function(e = false, t) {
...
// UMD global export for CDN usage
window.MindElixir = k;
